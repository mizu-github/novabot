...
public class Config {
    ...
    private static final String[] formattingVars = new String[]{"title", "titleUrl", "body", "content","showThumbnail", "showColor", "showMap", "mapZoom", "mapWidth", "mapHeight"};
    ...
    public static void main(String[] args) {
        ...
        RaidSpawn raidSpawn = new RaidSpawn("gymname", "gymid", -35, 149, Team.Valor, ZonedDateTime.now(),ZonedDateTime.now(), 0,50012,1,2,5,0);
    ...
    public boolean showThumbnail(String fileName, String formatKey) {
        return Boolean.parseBoolean(formats.get(fileName).getFormatting(formatKey, "showThumbnail"));
    }
